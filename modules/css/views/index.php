...
class View extends \Kotchasan\KBase
{
    ...
    public function index()
    {
        ...
        $data2 .= 'header.header,body.welcomepage,.language-menu li>a:hover,.topmenu>ul ul>li.hover>a,.topmenu>ul ul>li.hover>.menu-arrow,.topmenu>ul ul>li:hover>a,.topmenu>ul ul>li:hover>.menu-arrow,.gdpanel a:hover{background-color:'.self::$cfg->bg_color.'}';
        $data2 .= 'header.header .td,.topmenu>ul>li,.language-menu li>a:hover,.topmenu>ul ul>li.hover>a,.topmenu>ul ul>li.hover>.menu-arrow,.topmenu>ul ul>li:hover>a,.topmenu>ul ul>li:hover>.menu-arrow,.gdpanel a:hover{color:'.self::$cfg->color.'}';
